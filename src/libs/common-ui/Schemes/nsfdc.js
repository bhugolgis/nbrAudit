...
import { Collapse, Table, Button, Modal, Spin } from "antd";
...
import { NSFDCLogo } from "../../../media";
const { Panel } = Collapse;

const NsfdcSchemes = (props) => {
  const { userList, loanList, loading } = useSchemes("nsfdc");
  const NsfdcData = [
    ...
    { title: "Loan Limit(INR)", dataIndex: "LoanLimit" },
    {
      ...
      children: [
        ...
        { title: "NSFDC", dataIndex: "ContributionNSFDC" },
    ...
    return (
      <Container>
        <span style={{ display: "flex" }}>
          <img src={NSFDCLogo} width="3%" height="3%" />
          <Head>NSFDC Scheme</Head>
        </span>
        <div class="clearfix"></div>
        <h2>Procedures to be followed while implementing NSFDC scheme</h2>
        <p>
          Various schemes are implemented under Mahatma Phule Backward Classes
          Development Corporation under NSFDC, New Delhi. The details are as
          follows.
        </p>
        <b>
        ...
        <DataTable dataSource={loanList.results} columns={NsfdcData} />

        <h3>A) Documents required for loan approval.</h3>
        <ol>
          <li>Caste Certificate / Dakhala</li>
          <li>
        ...
        <ol>
          ...
          <li>
            The LOI application is made to NSFDC, New Delhi as per the loan
            proposal received from the Regional Office.
          </li>
          <li>
            Upon receipt of LOI from NSFDC, New Delhi, the loan proposal is
          ...
          <li>
            NSFDC New Delhi seeks funding after receiving a funding proposal
            from the Regional Office.
          </li>
          <li>
            Following the receipt of funds from NSFDC, New Delhi, the
