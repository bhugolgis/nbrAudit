...
// Training Application List with view functionality and it is a common component for all the users wherever applicable.

const { Option } = Select;
const { Panel } = Collapse;

const TrainingApplications = () => {
  const { pendingList, shortlistedList, selectedList } = useTraining();
  ...
  const trainingApplicationList = [
    ...
    {
      title: "Actions",
      dataIndex: ["id", "adminTrainingList"],
      render: (text, listData) => {
        if (
          (UserGroup == "districtManager" || UserGroup == "admin") &&
          listData.trainingFinalStatus == "Pending"
        ) {
          return (
            <>
              <a onClick={showModal}>
              ...
              >
                <Form layout="vertical">
                  <StatusFields>
                    ...
                    <Form.Item label="Final Status" required>
                      <Select
                        style={{ width: "220px" }}
                        onChange={(v) => {
                          setFinalStatus(v);
                  ...
                  <Form.Item>
                    <Button
                      type="primary"
                      onClick={() => {
                        if (UserGroup == "admin" && finalStatus != null) {
                          axios
                            .patch(
                              `${REACT_APP_BASE_URL}/training/ChangeTrainingApplicationStatus/${trainingId}/`,
                              {
                                trainingFinalStatus: finalStatus,
                              },
                              {
                                headers: {
        ...
        {/* <Tabs
          ...
          items={[
            ...
            },
            {
              ...
              key: "4",
              children: <DataTable columns={trainingApplicationList} />,
            },
          ]} */}
