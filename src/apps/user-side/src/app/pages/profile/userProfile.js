  ...
  if (pageLoading == true) {
    ...
    return (
      <MainContainer>
        <Heading>
          <h2>
            {userDetails.name} - {userDetails.uniqueId}
          </h2>
          <Button type="primary">
            {sessionStorage.getItem("userGroup") == "beneficiary" ? (
                ...
                <Row>
                  <Col span={6}>
                    <SubHeading>
                      ...
                      {userDetails.UserPersonalInfo[0].maritalStatus ==
                      false ? (
              ...
              <Row>
                <Col span={6}>
                  <SubHeading>
                    ...
                    :
                    <br />
                    {userDetails.CustomUserOtherInfo[0].isFatherAlive ==
                    true ? (
                      <SubHeading>Yes</SubHeading>
                    ) : (
                      <SubHeading>No</SubHeading>
              ...
              <Row>
                ...
                <Col span={6}>
                  <SubHeading>
                    ...
                    :
                    <br />
                    {userDetails.CustomUserOtherInfo[0].isMotherAlive ==
                    true ? (
                      <SubHeading>Yes</SubHeading>
                    ) : (
                      <SubHeading>No</SubHeading>
